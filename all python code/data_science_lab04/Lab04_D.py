...
def transition_matrix(n):
    ...
    half = math.ceil(n/2)
    iuh = np.arange(0, half)  # indices under half(n/2)
    ioh = np.arange(half, n)  # indices over half(n/2)
...
def main():
    ...
    print(f'It takes {step} steps for the probability of being in the final state (𝑖 = 9) to be at least 1%')
