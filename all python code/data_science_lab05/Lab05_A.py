...
def main():
    ...
    '''
    SALES_DATA_DF = pd.read_csv('D:\python projects\data_science_lab05\sales_data.csv')
    ...
    ax1.set(xticks=x, yticks=[7500, 10000, 12500], 
            title='Sales data of a Bathingsoap')

    ax2.plot(x, y2, color='k', marker='o', lw=3)
    ax2.set(yticks=[1500, 2000], title='Sales data if a facewash',
            xlabel='Month Number')
