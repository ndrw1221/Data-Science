...
def main():
    ...
    barD = ax.barh(
        ...
        edgecolor="white",
        label="Team D",
        zorder=3,  # for bars to appear before the grid
    )
    # Label the leaders' names at the center of each bar.
    ax.bar_label(barD, labels=TeamD.Leader, label_type="center", fontsize="large")
    ...
    # Label the leaders' names at the center of each bar.
    ax.bar_label(barK, labels=TeamK.Leader, label_type="center", fontsize="large")
    ...
    # Label the leaders' names at the center of each bar.
    ax.bar_label(barP, labels=TeamP.Leader, label_type="center", fontsize="large")
    ...
    plt.legend(loc="lower right", handlelength=0.7, borderpad=1, labelspacing=1.2)
