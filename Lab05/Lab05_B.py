...
def main():
    ...
    scatter_df = pd.read_excel("Scatter.xlsx")
    ...
    center_ax.scatter(
        Cc.PC1, Cc.PC2, c="yellow", marker="o", edgecolors="k", lw=0.8, label="C/c"
    )
    center_ax.scatter(
        CC.PC1,
        CC.PC2,
